    ...
    return (
        <Container size="lg" py="xl">
            ...
            <Text c="dimmed" className={classes.description} ta="center" mt="md">
                AthensHub focuses on making quality education accessible to everyone, especially targeting underserved communities. It facilitates collaborative learning and knowledge sharing through a peer-supported network.
            </Text>
